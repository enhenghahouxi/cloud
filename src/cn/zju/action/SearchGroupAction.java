...
public class SearchGroupAction  extends ActionSupport implements Serializable {
	...
	public String execute() throws Exception  {
		...
		List<Group> list;
		try {
			list = service.getAllGroups(this);
		} catch (Exception e) {
			e.printStackTrace();
			return INPUT;
		} 
		...
		pageBean.setTotalrecord(service.countGroups(this));
