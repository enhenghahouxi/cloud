...
public class DownloadAction extends ActionSupport implements Serializable{
	...
	public String download(){
		...
		try {
			...
			//通知浏览器以下载方式打开
		    ServletActionContext.getResponse().setHeader("content-disposition", "attachment;filename=" + URLEncoder.encode(filename,"ISO8859-1"));
			//ServletActionContext.getResponse().setHeader("content-disposition", "attachment;filename=" + URLEncoder.encode(filename,"GBK"));
