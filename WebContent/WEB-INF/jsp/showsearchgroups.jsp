...
<head>
    ...
    <title>SkyGroup云存储-群组搜索结果</title>
    <meta charset="utf-8" />
...
<body >
	<nav class="navbar navbar-fixed-top my-navbar" role="navigation">
	  ...
	  <br/>
	  <font size="60px">Groups搜索结果</font><br/><br/>
	    ...
	    <table frame="border" width="100%" align="center">
	    	...
	    	<c:forEach var="c" items="${requestScope.pagebean.list}" varStatus="stat">
	    		<tr class="${stat.count%2==0?'even':'old'}">
		    		...
		    		<td>
		    			<a href="${pageContext.request.contextPath}/requestjoingroup.action?groupname=${c.groupname}" style="color:black;">->加入该群</a>
		    		</td>
	    		<tr>
	    	</c:forEach>
