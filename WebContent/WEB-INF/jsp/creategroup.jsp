...
<head>
	...
	<title>G13-SkyCloud云存储系统－创建群组</title>
...
<div class="bg">
	...
	<div class="box">
	<form action="${pageContext.request.contextPath}/creategroup.action"  class="signin-form" method="post">
		<div >
			<input class="form-control form-input" placeholder="请设置群组名(英文或数字6-20位)" type="text" name="groupname"/>
		</div>
		<div class="" style="margin: 20px 0;">
			<input class="form-control form-input" placeholder="请设置入群暗号(英文或数字6-20位)" type="password" name="invitecode"/>
		</div>
		<div class="" style="margin: 20px 0;">
			<input class="form-control form-input" placeholder="请重复入群暗号(英文或数字6-20位)" type="password" name="invitecode2"/>
		</div>
		<div class="colorwhite">${groupnameerror}</div>
		<div class="colorwhite">${invitecodeerror}</div>
		<div><input type="submit" class="btn btn-primary btn-submit" value="创&nbsp;&nbsp;建" ></div>
	</form>
	</div>
	</div>
</div>
