...
<head>
    ...
    <title>G13-SkyCloud云存储－搜索群组</title>
    <meta charset="utf-8" />
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav">
      			...
      			<li> <a href="${pageContext.request.contextPath}/grouphome.jsp?user_name=${user_name}" >我的群组</a></li>
...
<div class="bg">
	...
	<div class="signin">
		...
		<div class="box">
			<div style="font-size: 20px ; color: white; font-style: italic;color:white;">在 SkyCloud 中搜索你想要加入的小组吧～</div>
	   	    <form action="${pageContext.request.contextPath}/searchgroup.action" method="post" onsubmit='return validation();' style="margin: 10px">
	    			 <div class="" style="margin: 20px 0;">
	              <input class="form-control form-input" placeholder="输入群组名" type="test" id="searchcontent" name="searchcontent"/>
	              </div>
